/*
  ...
  ./gengetopt -i ./vanityETHMPI_cmd.ggo -F vanityETHCmdline --include-getopt 
...
#include "vanityETHCmdline.h"

const char *gengetopt_args_info_purpose = "Calculates ETH Vanity Addresses in Parallel";

const char *gengetopt_args_info_usage = "Usage: vanityETHMPI [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -i, --input=STRING  Input HEX string",
  "  -c, --count=INT     Number of wallets to generate  (default=`1')",
  "      --contract      Require first contract address to match input  \n                        (default=off)",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->contract_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->contract_given)
    write_into_file(outfile, "contract", 0, 0 );
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:c:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'i':	/* Input HEX string.  */
          ...
          break;
        case 'c':	/* Number of wallets to generate.  */
        ...
        case 0:	/* Long option with no short option */
          /* Require first contract address to match input.  */
          if (strcmp (long_options[option_index].name, "contract") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->contract_flag), 0, &(args_info->contract_given),
                &(local_args_info.contract_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "contract", '-',
                additional_error))
              goto failure;
